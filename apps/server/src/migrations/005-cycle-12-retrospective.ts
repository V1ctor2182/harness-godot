...
const RETROSPECTIVE_ID = 'retrospectives/cycle-12.md';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-12-retrospective.md');
  ...
  console.log(`[migration 005] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
