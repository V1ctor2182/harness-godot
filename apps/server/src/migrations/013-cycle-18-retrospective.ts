...
const RETROSPECTIVE_ID = 'retrospective/cycle-18';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-18-retrospective.md');
  ...
  console.log(`[migration 013] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
