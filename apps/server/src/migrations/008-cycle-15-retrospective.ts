...
const RETROSPECTIVE_ID = 'retrospectives/cycle-15-retrospective.md';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-15-retrospective.md');
  ...
  console.log(`[migration 008] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
