...
const RETROSPECTIVE_ID = 'retrospectives/cycle-11.md';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-11-retrospective.md');
  ...
  console.log(`[migration 004] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
