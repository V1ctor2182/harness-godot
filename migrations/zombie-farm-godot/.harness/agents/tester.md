...
1. **PRD formulas**: `cat prd/00b-global-formulas.md` — authoritative formulas for L4 compliance checks
2. **Relevant PRD**: Read the `prd/` file matching the task's prdRefs — this is what L4 compares code against
3. **Conventions**: `cat knowledge/conventions.md` if present — coding standards to verify
