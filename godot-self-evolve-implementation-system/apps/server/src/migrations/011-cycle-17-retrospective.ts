...
const RETROSPECTIVE_ID = 'retrospective/cycle-17';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-17-retrospective.md');
  ...
  console.log(`[migration 011] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
