...
const RETROSPECTIVE_ID = 'retrospective/cycle-16';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-16-retrospective.md');
  ...
  console.log(`[migration 010] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
