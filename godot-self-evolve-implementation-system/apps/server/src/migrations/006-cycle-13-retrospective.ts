...
const RETROSPECTIVE_ID = 'retrospectives/cycle-13-retrospective.md';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-13-retrospective.md');
  ...
  console.log(`[migration 006] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
