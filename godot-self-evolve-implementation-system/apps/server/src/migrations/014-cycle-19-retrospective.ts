...
const RETROSPECTIVE_ID = 'retrospective/cycle-19';
...
export async function up(): Promise<void> {
  const retroFilePath = path.join(KNOWLEDGE_DIR, 'cycle-19-retrospective.md');
  ...
  console.log(`[migration 014] ${retroAction} knowledge file ${RETROSPECTIVE_ID}`);
}
